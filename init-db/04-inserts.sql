-- ==========================================
-- 04-inserts.sql
-- Datos de prueba (Mock Data) para VCT Stats
-- ==========================================
...
('U02', 'Pozo de la Víbora', 0, 8, 2.0),
('U03', 'Tumba de Bajas', 150, 8, 1.0),
('U04', 'Desde las Sombras', 0, 7, 2.5),
('U05', 'Pozo de Gravedad', 0, 8, 1.0),
('U06', 'Trueno Retumbante', 0, 8, 2.2),
('U07', 'Golpe Orbital', 150, 8, 3.0),
('U08', 'Cazador de Cabezas', 100, 8, 0.5),
('U09', 'Aún No Muero', 0, 8, 2.0),
('U10', 'Hurto de Neuronas', 0, 7, 1.0),
('U11', 'Aniquilación', 150, 8, 2.0),
('U12', 'Ocaso', 0, 8, 2.0),
('U13', 'X_D_I_S_T_A_N_C_I_A', 0, 8, 1.5),
('U14', 'Bloqueo', 0, 9, 3.0),
('U15', 'Aullido de Ajuste', 0, 7, 1.5),
('U16', 'Matar por Contrato', 150, 7, 1.0),
('U17', 'NULL/cmd', 0, 8, 1.0),
('U18', 'Sobrecarga', 0, 7, 1.0),
('U19', 'Fénix Renacido', 0, 8, 1.0),
('U20', 'Empatía de la Emperatriz', 0, 7, 0.5),
('U21', 'Resurrección', 0, 9, 2.5),
('U22', 'Buscadores', 0, 7, 1.5),
('U23', 'Furia del Cazador', 80, 8, 1.5),
('U24', 'Golpe Sísmico Regional', 120, 8, 2.0),
('U25', 'Línea de Bloqueo', 100, 7, 1.0),
('U26', 'Jardín de Acero', 0, 8, 2.0),
('U27', 'Camino del Mañana', 120, 8, 1.8),
('U28', 'Cambio de Dimensión', 0, 7, 1.0)
ON CONFLICT (Id_Ultimate) DO NOTHING;
...
('E13', 'Fnatic', 'Elmapuddy', 'EMEA'),
('E14', 'Natus Vincere', 'd00mbros', 'EMEA'),
('E15', 'Team Vitality', 'Salah', 'EMEA'),
('E16', 'Team Heretics', 'Neilzinho', 'EMEA'),
('E17', 'Karmine Corp', 'Engh', 'EMEA'),
('E18', 'FUT Esports', 'GAIS', 'EMEA'),
('E19', 'Paper Rex', 'alecks', 'Pacific'),
('E20', 'DRX', 'Termi', 'Pacific'),
('E21', 'Gen.G Esports', 'solo', 'Pacific'),
('E22', 'T1', 'Autumn', 'Pacific'),
('E23', 'ZETA DIVISION', 'Carlao', 'Pacific'),
('E24', 'Team Secret', 'Warbirds', 'Pacific'),
('E25', 'EDward Gaming', 'Muggle', 'China'),
('E26', 'FunPlus Phoenix', 'NaVi', 'China'),
('E27', 'Trace Esports', 'Feng', 'China'),
('E28', 'All Gamers', 'Yi', 'China')
...
('H01', 'Impulso/Viento de Cola', 'E', 0, 1, 0.1, 'U01'),
('H02', 'Nube Venenosa', 'Q', 0, 1, 0.5, 'U02'),
('H03', 'Balas de Pintura', 'E', 55, 1, 0.5, 'U03'),
('H04', 'Paranoia', 'Q', 0, 1, 0.5, 'U04'),
('H05', 'Pulso Nova', 'Q', 0, 1, 0.5, 'U05'),
('H06', 'Línea de Falla', 'E', 0, 1, 1.0, 'U06'),
('H07', 'Cortina de Humo', 'E', 0, 3, 0.5, 'U07'),
('H08', 'Marca Registrada', 'C', 0, 1, 0.8, 'U08'),
('H09', 'Artimaña', 'E', 0, 2, 0.5, 'U09'),
('H10', 'Prisión Ciber', 'Q', 0, 2, 0.1, 'U10'),
('H11', 'Malla de Barrera', 'E', 0, 1, 0.5, 'U11'),
('H12', 'Trampa', 'E', 0, 1, 0.7, 'U12'),
('H13', 'Carnalito', 'Q', 0, 1, 0.5, 'U13'),
('H14', 'Torreta', 'E', 11, 1, 0.8, 'U14'),
('H15', 'Marea Alta', 'E', 0, 1, 0.5, 'U15'),
('H16', 'Flujo', 'E', 0, 1, 0.2, 'U16'),
('H17', 'PUNTO/Cero', 'E', 0, 1, 0.5, 'U17'),
('H18', 'Velocidad Relámpago', 'E', 0, 1, 0.1, 'U18'),
('H19', 'Combustión', 'E', 60, 1, 0.5, 'U19'),
('H20', 'Devorar', 'Q', 0, 2, 0.1, 'U20'),
('H21', 'Orbe de Barrera', 'C', 0, 1, 0.5, 'U21'),
('H22', 'Luz Guía', 'E', 0, 2, 0.3, 'U22'),
('H23', 'Proyectil de Reconocimiento', 'E', 0, 1, 0.5, 'U23'),
('H24', 'Fuego Cruzado', 'E', 50, 1, 0.8, 'U24'),
('H25', 'Línea de Bloqueo', 'E', 0, 1, 0.5, 'U25'),
('H26', 'Rosa de Cizalla', 'E', 0, 1, 0.5, 'U26'),
('H27', 'Carga Crucial', 'E', 40, 2, 0.4, 'U27'),
('H28', 'Infiltración', 'E', 0, 2, 0.5, 'U28')
...
('AG01', 'H01', 1),
('AG02', 'H02', 1)
ON CONFLICT (Id_AgenteFK, Id_HabilidadFK) DO NOTHING;
...
('P03', 'E04', TRUE),
('P03', 'E05', FALSE)
ON CONFLICT (Id_PartidaFK, Id_EquipoFK) DO NOTHING;
...
ON CONFLICT (ID_Estadistica) DO NOTHING;

INSERT INTO Estadistica_Jugador (Id_estadistica_jugador, kills, death, assists, Id_PlayerFK, Id_AgenteFK, Id_Partido) VALUES
('EJ01', 25, 18, 5, 'J01', 'AG03', 'P01'),
('EJ02', 28, 15, 4, 'J03', 'AG01', 'P01'),
('EJ03', 12, 16, 15, 'J04', 'AG04', 'P01'),
('EJ04', 22, 14, 8, 'J05', 'AG02', 'P02'),
('EJ05', 18, 19, 6, 'J01', 'AG03', 'P02'),
('EJ06', 29, 12, 6, 'J06', 'AG01', 'P03'),
('EJ07', 15, 14, 18, 'J07', 'AG04', 'P03'),
('EJ08', 21, 18, 4, 'J08', 'AG03', 'P03')
ON CONFLICT (Id_estadistica_jugador) DO NOTHING;

INSERT INTO Uso_Armas_Jugador (Id_Uso_Arma, Id_estadistica_jugadorFK, Id_ArmaFK, Kills_con_arma, Dano_con_arma) VALUES
('UA01', 'EJ01', 'A01', 20, 3000),
('UA02', 'EJ02', 'A03', 15, 2250)
ON CONFLICT (Id_Uso_Arma) DO NOTHING;
